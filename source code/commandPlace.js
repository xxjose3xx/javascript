...
function sendCommand(command) {
    var data = {
        ...
        spear: $("#unit_input_spear")[0].value*1,
        sword: $("#unit_input_sword")[0].value*1,
        axe: $("#unit_input_axe")[0].value*1,
        spy: $("#unit_input_spy")[0].value*1,
        light: $("#unit_input_light")[0].value*1,
        heavy: $("#unit_input_heavy")[0].value*1,
        ram: $("#unit_input_ram")[0].value*1,
        catapult: $("#unit_input_catapult")[0].value*1,
        knight: $("#unit_input_knight")[0].value*1,
        snob: $("#unit_input_snob")[0].value*1,
        x: $("#coordX")[0].value,
        y: $("#coordY")[0].value,
        target_type: "coord",
        input: "",
