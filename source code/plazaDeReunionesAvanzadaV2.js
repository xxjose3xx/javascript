function mostrarTabla() {
    ...
    $.get("/game.php?village=" + game_data.village.id + "&screen=place", function(html) {
        ...
        //Añadir filto al input para coordenadas
...
function atacar() {
    var url = "/game.php?village=" + game_data.village.id + "&screen=place&try=confirm";
    var data = {
        o: "",
        template_id: "",
    ...
    $.post(url, data, function(html) {document.write(html)});
};